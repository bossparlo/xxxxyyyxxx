...
var link_StrayRogue = "<a href=\"https://twitter.com/StrayRogue\" target=\"_blank\">@Argent</a>";
var link_DitzyFlama = "<a href=\"https://twitter.com/DitzyFlama\" target=\"_blank\">@Gaia</a>";
var link_EricHuber = "<a href=\"https://erics.site/?utm_source=bongo.cat\" target=\"_blank\">Argent</a> (<a href=\"https://discord.gg/Nt4S9fqaGa\" target=\"_blank\">@Externalizable</a>)";
var i18n_map = {
  "Bongos": {
    "en": "Bongos",
    "tr": "Bongos"},
  ...
  "MEOW": {
    ...
    "tr": "Miyav"},
  "other-lang": {
    "en": "<a href=\"/?lang=ca\">İngilizce</a>",
    "tr": "<a href=\"/?lang=en\">Türkçe</a>"},
  "courtesy": {
    "en": "Art courtesy of "+link_Argent,
    "tr": "Sanat izniyle "+link_Argent},
  "meme": {
    "en": "Meme by "+link_Argent,
    "tr": "Yazan: "+link_Argent},
  "website": {
    "en": "Website by "+link_Argent,
    "tr": "Web sitesi"+link_Argent},
  "cookies": {
    "en": "This website uses cookies to analyze traffic via anonymized and aggregated data.",
    "tr": "Bu web sitesi, anonim ve toplu veriler aracılığıyla trafiği analiz etmek için çerezler kullanır."}
};
